...
class Plugin {
	constructor($container, initialColor, handleColorChange) {
...
function tinycolorpicker($container, handleChangeColor, color = "#EFEFEF") {
...
class TinyColorpicker extends Component {
	componentDidMount() {
		...
		const picker  = tinycolorpicker($picker, this.props.handleColorChange, this.props.color)
	}
